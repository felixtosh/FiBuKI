...
// =============================================================================
async function creditReferrer(db, stripe, referredUserId, subData) {
    ...
    try {
        ...
        const planConfig = config_1.PLANS[referrerPlan] || config_1.PLANS.smart;
        ...
        console.log(`[StripeWebhook] Referral credit applied: referrer=${conversion.referrerUserId} ` +
...
// =============================================================================
async function handleCountryBacking(db, session) {
    ...
    await countryRef.update({
        currentBackers: firestore_1.FieldValue.increment(1),
        totalCommitted: firestore_1.FieldValue.increment(session.amount_total || 1000),
    });
