    ...
    <div className="space-y-6">
      ...
      {isComplete && results && (
        <div className="grid grid-cols-2 gap-4">
          {[
            { icon: CheckCircle2, iconColor: "text-green-600 dark:text-green-400", bgColor: "bg-green-50 border border-green-200 dark:bg-green-950/30 dark:border-green-900", label: "Imported", value: results.imported, total: results.total },
            { icon: AlertCircle, iconColor: "text-yellow-600 dark:text-yellow-400", bgColor: "bg-yellow-50 border border-yellow-200 dark:bg-yellow-950/30 dark:border-yellow-900", label: "Skipped (duplicates)", value: results.skipped, total: results.total },
            { icon: XCircle, iconColor: "text-destructive", bgColor: "bg-red-50 border border-red-200 dark:bg-red-950/30 dark:border-red-900", label: "Errors", value: results.errors, total: results.total },
            { icon: CheckCircle2, iconColor: "text-muted-foreground", bgColor: "bg-muted border border-border", label: "Total processed", value: results.total, total: undefined },
          ].map((card, index) => (
            <div
              key={card.label}
